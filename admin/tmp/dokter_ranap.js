...
$("#form_soap").on("click", "#simpan_soap", function(event){
    ...
    spo2 : spo2
      ...
      $('input:text[name=tgl_perawatan]').val("2024-12-09");
      $('input:text[name=tgl_registrasi]').val("2024-12-09");
      $('input:text[name=jam_rawat]').val("13:40:24");
...
$(document).ready(function () {
  ...
  $('.databarang_ajax').selectator({
    ...
    load: function (search, callback) {
      ...
      $.ajax({
        url: 'http://localhost/Edokter/admin/dokter_ranap/ajax?show=databarang&nama_brng=' + encodeURIComponent(search) + '&t=4513c1a34d6d',
        type: 'GET',
        dataType: 'json',
